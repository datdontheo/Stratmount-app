const variants = {
  ...
  PENDING: 'badge-pending',
  ADMIN: 'bg-white/10 text-white text-xs px-2 py-0.5 rounded-full font-medium',
...
export default function Badge({ value }) {
  const cls = variants[value] || 'bg-white/10 text-white text-xs px-2 py-0.5 rounded-full font-medium';
